    ...
    <nav className="w-full bg-[#212428]  fixed t z-50  text-white py-5 h-20 px-5">
      <div className="max-w-6xl mx-auto  flex justify-between items-center font-bodyFont">
        ...
        >
          ...
          <NavLink className={"hover:text-rose-600 duration-300"} to="/about">
            About
          </NavLink>
          <NavLink className={"hover:text-rose-600 duration-300"} to="/menu">
            Menu
          </NavLink>
          <NavLink className={"hover:text-rose-600 duration-300"} to="/gallery">
            Gallery
          </NavLink>
          <NavLink className={"hover:text-rose-600 duration-300"} to="/chefs">
            Our Chef
          </NavLink>
          <NavLink className={"hover:text-rose-600 duration-300"} to="/blogs">
            Blogs
          </NavLink>
          <NavLink className={"hover:text-rose-600 duration-300"} to="/contact">
            Contact
          </NavLink>
          <NavLink className={"hover:text-rose-600 duration-300"} to="/login">
            Sign in/up
          </NavLink>
          {user ? (
            <>
